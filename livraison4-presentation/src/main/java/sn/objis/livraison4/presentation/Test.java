...
public class Test {
	...
	public static void main(String[] args) {
		...
		case 1:
			String rep;
			case1(args, sc, iServiceMedecinImpl, generateCode);
			Test.main(args);
			break;
		case 2:
			String rep1;
			case2(args, sc, iServicePatientImpl, generateCode);
			Test.main(args);
			break;
		case 3:
			String rep2;
			case3(args, sc, iServiceSecretaireImpl, generateCode);
			Test.main(args);
			break;
		case 4:
	...
	private static void case3(String[] args, Scanner sc, IServiceSecretaireImpl iServiceSecretaireImpl,
	...
	private static void case2(String[] args, Scanner sc, IServicePatientImpl iServicePatientImpl,
			GenerateCode generateCode) {
		int choix2;
		String rep1;
		do {
	...
	private static void case1(String[] args, Scanner sc, IServiceMedecinImpl iServiceMedecinImpl,
			GenerateCode generateCode) {
		int choix2;
		String rep;
		do {
