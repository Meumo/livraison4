...
public class Test {
	...
	public static void main(String[] args) {
		...
		case 1:
			caseMedecin(args, sc, iServiceMedecinImpl, generateCode);
			Test.main(args);
			break;
		case 2:
			casePatient(args, sc, iServicePatientImpl, generateCode);
			Test.main(args);
			break;
		case 3:
			caseSecretaire(args, sc, iServiceSecretaireImpl, generateCode);
			Test.main(args);
			break;
		case 4:
	...
	private static void caseSecretaire(String[] args, Scanner sc, IServiceSecretaireImpl iServiceSecretaireImpl,
	...
	private static void casePatient(String[] args, Scanner sc, IServicePatientImpl iServicePatientImpl,
			GenerateCode generateCode) {
		int choix2;
		String rep1;
		do {
	...
	private static void caseMedecin(String[] args, Scanner sc, IServiceMedecinImpl iServiceMedecinImpl,
			GenerateCode generateCode) {
		int choix2;
		String rep;
		do {
